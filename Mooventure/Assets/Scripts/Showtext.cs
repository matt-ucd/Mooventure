...
public class Showtext : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        texts.Add("Are you ready? Let me give you a quick tutorial before you head off on a campus tour! ");
        ...
        texts.Add("You are ready to go! Start the game anytime and I¡¯ll see you on the other side.");
